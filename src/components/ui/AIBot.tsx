...
// import { useNavigate, useLocation } from 'react-router-dom';
// import { UserCircle2, Bot } from 'lucide-react';
// import { FaPause } from 'react-icons/fa'; // Import the pause/play icons
// import ReactMarkdown from 'react-markdown';
// import remarkGfm from 'remark-gfm';
...
//   const fetchBotResponse = async (userMessage: string) => {
//     if (isLoading || lock || isPaused) return;
...
//         <button onClick={togglePause} className="text-gray-400 hover:text-white mb-6">
//           {isPaused ? 'Resume' : 'Pause'} Streaming
//         </button>
