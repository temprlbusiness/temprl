...
export const AIBot = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-950 text-white">
      <div className="flex-1 flex flex-col justify-start items-center text-center w-full max-w-3xl mx-auto px-4 pt-16 pb-20">
        ...
        <div className="fixed bottom-8 right-0 z-50 flex flex-col items-center w-[calc(100%-260px)] pointer-events-auto">
          <div className="flex items-center bg-gray-800 rounded-xl p-3 w-[800px] shadow-lg">
            <input
              type="text"
              value={input}
